...
bold and efficacious protagonist in one of [Zacharias Topelius short stories](https://topelius.sls.fi/sv/collection/211/text/20211). It allows, among other things, editors to manage information about publications and facsimiles in the digital edition database, and upload facsimile images to the backend. It relies on the [SLS Digital Edition API][digital_edition_api].
...
»Vincent» was originally developed by [Identio][identio] (commissioned by SLS in October 2024).
