...
- Zoneless migration phase 7: remove Zone.js from application and test configuration and use Angular 22's zoneless change-detection defaults throughout the application.
