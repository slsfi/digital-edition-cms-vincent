...
- Auth: require successful CMS-user validation via `/session/validate_cms` before accepting login, and use CMS-user session validation for explicit session checks.
